...
FMOD_RESULT FMOD_System_SetStreamBufferSize (FMOD_SYSTEM* system, uint filebuffersize, FMOD_TIMEUNIT filebuffersizetype);
FMOD_RESULT FMOD_System_GetStreamBufferSize (FMOD_SYSTEM* system, uint* filebuffersize, FMOD_TIMEUNIT* filebuffersizetype);
...
FMOD_RESULT FMOD_Sound_GetLength (FMOD_SOUND* sound, uint* length, FMOD_TIMEUNIT lengthtype);
...
FMOD_RESULT FMOD_Sound_GetOpenState (FMOD_SOUND* sound, FMOD_OPENSTATE* openstate, uint* percentbuffered, FMOD_BOOL* starving, FMOD_BOOL* diskbusy);
...
FMOD_RESULT FMOD_Sound_GetSyncPointInfo (FMOD_SOUND* sound, FMOD_SYNCPOINT* point, char* name, int namelen, uint* offset, FMOD_TIMEUNIT offsettype);
FMOD_RESULT FMOD_Sound_AddSyncPoint (FMOD_SOUND* sound, uint offset, FMOD_TIMEUNIT offsettype, const(char)* name, FMOD_SYNCPOINT** point);
...
FMOD_RESULT FMOD_Sound_SetLoopPoints (FMOD_SOUND* sound, uint loopstart, FMOD_TIMEUNIT loopstarttype, uint loopend, FMOD_TIMEUNIT loopendtype);
FMOD_RESULT FMOD_Sound_GetLoopPoints (FMOD_SOUND* sound, uint* loopstart, FMOD_TIMEUNIT loopstarttype, uint* loopend, FMOD_TIMEUNIT loopendtype);
...
FMOD_RESULT FMOD_Channel_SetDelay (FMOD_CHANNEL* channel, ulong dspclock_start, ulong dspclock_end, FMOD_BOOL stopchannels);
FMOD_RESULT FMOD_Channel_GetDelay (FMOD_CHANNEL* channel, ulong* dspclock_start, ulong* dspclock_end, FMOD_BOOL* stopchannels);
...
FMOD_RESULT FMOD_Channel_SetPosition (FMOD_CHANNEL* channel, uint position, FMOD_TIMEUNIT postype);
FMOD_RESULT FMOD_Channel_GetPosition (FMOD_CHANNEL* channel, uint* position, FMOD_TIMEUNIT postype);
...
FMOD_RESULT FMOD_Channel_SetLoopPoints (FMOD_CHANNEL* channel, uint loopstart, FMOD_TIMEUNIT loopstarttype, uint loopend, FMOD_TIMEUNIT loopendtype);
FMOD_RESULT FMOD_Channel_GetLoopPoints (FMOD_CHANNEL* channel, uint* loopstart, FMOD_TIMEUNIT loopstarttype, uint* loopend, FMOD_TIMEUNIT loopendtype);
...
FMOD_RESULT FMOD_ChannelGroup_SetDelay (FMOD_CHANNELGROUP* channelgroup, ulong dspclock_start, ulong dspclock_end, FMOD_BOOL stopchannels);
FMOD_RESULT FMOD_ChannelGroup_GetDelay (FMOD_CHANNELGROUP* channelgroup, ulong* dspclock_start, ulong* dspclock_end, FMOD_BOOL* stopchannels);
